...
SECRET_KEY = 'z74ibn9+b-%$g=4=)z5bt@@m#{SECRET_KEY}k#!u9!)dl^h!(7y1auk_#{SECRET_KEY}_woz'
...
MIDDLEWARE = [
    ...
    'diplom.middleware.force_default_middleware.force_default_language_middleware',
