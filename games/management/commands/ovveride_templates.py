...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/games/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/games/templates && cd games/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
